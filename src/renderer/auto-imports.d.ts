...
declare global {
  ...
  const getMediaInfo: typeof import('./src/apis/bili-api')['getMediaInfo']
  const getPlaylist: typeof import('./src/apis/bili-api')['getPlaylist']
  ...
  const usePlayer: typeof import('./src/stores/player')['usePlayer']
